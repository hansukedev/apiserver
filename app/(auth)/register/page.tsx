...
export default function RegisterPage() {
    ...
    return (
        <div className="w-full">
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Adventure starts here 🚀</h2>
                <p className="text-gray-500 dark:text-gray-400">Make your app management easy and fun!</p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
                ...
                <div className="flex items-center">
                    ...
                    <label htmlFor="terms" className="ml-2 block text-sm text-gray-600 dark:text-gray-400">
                        I agree to <a href="#" className="text-[#7367F0]">privacy policy & terms</a>
                    </label>
                </div>
            ...
            <div className="mt-6 text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link href="/login" className="font-medium text-[#7367F0] hover:text-[#685dd8]">
                        Sign in instead
                    </Link>
                </p>
            </div>
